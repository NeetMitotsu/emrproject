...
public class Entity implements Comparable<Entity> {
    ...
    private String shengliBingliType;
    private int diff = 0;
    private boolean qst;
...
//		String ss = "C=明显变化 P=369:373 T=complaintsymptom A=absent";
//		Entity e = createBySaveStr(ss);
    ...
    public static Entity createBySaveStr(String saveStr) {
        ...
        for (String field : fieldStrs) {
            ...
            } else if (fn[0].equals("S")) {
                ent.setShengliBingliType(fn[1]);
            }
        }
        return ent;
...
//		    return ent;
    ...
    public static Entity createByAnnotationStr(String[] strs){
        final Entity entity = createByAnnotationStr(strs[0]);
        entity.setEntityType(strs[1]);
        return entity;
    }
    ...
    public String getShengliBingliType() {
        return shengliBingliType;
    }

    public void setShengliBingliType(String shengliBingliType) {
        this.shengliBingliType = shengliBingliType;
    }
    ...
    public String toSave() {
        String saveStr = "C=" + entity + " P=" + startPos + ":" + endPos + " T=" + getEntityType() + " S=" + getShengliBingliType();
